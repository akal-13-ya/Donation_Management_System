...
<html class="no-js">
	...
	<div class="page-heading text-center">
		...
		<div class="container zoomIn animated">
			...
			<h1 class="page-title">RESPONSE <span class="title-under"></span></h1>
            ...
            if (mysqli_num_rows($qry) > 0) {
                while ($row = mysqli_fetch_assoc($qry)) {
                    ...
                    echo "<td style='padding: 12px; text-align: center; border: 1px solid #ddd;'>{$balanceAmount}</td>";
					  ...
					  echo "<td style='padding: 12px; text-align: center; border: 1px solid #ddd;'><a href='view1.php?id={$row['id']}'> view donars</a></td>";
}
